...
/// A custom editor for properties on the WwiseResonanceAudioRoom script. This appears in the
/// Inspector window of a WwiseResonanceAudioRoom object.
[CustomEditor(typeof(WwiseResonanceAudioRoom))]
[CanEditMultipleObjects]
public class WwiseResonanceAudioRoomEditor : Editor {
  ...
  public override void OnInspectorGUI () {
    ...
    WwiseResonanceAudio.roomEffectsBusName =
        EditorGUILayout.TextField(roomEffectsBusNameLabel, WwiseResonanceAudio.roomEffectsBusName);
    EditorGUI.EndDisabledGroup ();
    ...
    EditorGUILayout.Slider(reflectivity, 0.0f, WwiseResonanceAudio.maxReflectivity,
                           reflectivityLabel);
    ...
    ++EditorGUI.indentLevel;
    EditorGUILayout.Slider(reverbGainDb, WwiseResonanceAudio.minGainDb,
                           WwiseResonanceAudio.maxGainDb, reverbGainLabel);
    EditorGUILayout.Slider(reverbBrightness, WwiseResonanceAudio.minReverbBrightness,
                           WwiseResonanceAudio.maxReverbBrightness, reverbBrightnessLabel);
    EditorGUILayout.Slider(reverbTime, 0.0f, WwiseResonanceAudio.maxReverbTime, reverbTimeLabel);
    --EditorGUI.indentLevel;
